# The first part consists of a finite state machine that aims to transform a number from base 2 to base 3.
...
# The second part consists of a synchronous sequential circuit that hides a secret message in an image.
